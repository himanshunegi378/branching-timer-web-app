...
import TimerCardUI from './TimerCardUI';
import { Button } from '../../component/atoms/Button/Button.atom';
import TimerCardsModule from './TimerCardsModule';
import useDataStore from '../../hooks/useDataStore';
import { DataStore } from '../DataStore';

export const TimerCardBoard = () => {
  const injector = useInjector();
  const timerCardsModule: TimerCardsModule = injector.get('timerCards');
  ...
  const timerCards = useDataStore(dataStore, 'timerCardsStore');
  const timerCardIds = Object.keys(timerCards);
    ...
    <div>
                  ...
                  >
                    <TrelloItem>
                      <TimerCardUI
                        ...
                        onDelete={(id: string) => {
                          actions.invoke('timerCard/delete', 1, id);
                        }}
                      />
                    </TrelloItem>
                  </motion.div>
              ...
              >
                <TrelloItem>
                  <Button
                    ...
                    onClick={async () => {
                      const timerCard: TimerCard = await actions.invoke(
                        'timerCard/create',
                        1
                      );
                      timerCard.addTimer({
      ...
      <div className='bg-gray-100'>
        <div className='container mx-auto px-4 py-8'>
          <h1 className='text-5xl font-bold'>TimerCards</h1>
          <h2 className='text-2xl font-bold mb-2 text-gray-500'>
            A Versatile Timer App for Efficient Time Management
          </h2>

          <div className='mb-8'>
            <h2 className='text-2xl font-bold mb-2'>What is TimerCards?</h2>
          ...
          <div className='mb-8'>
            <h2 className='text-2xl font-bold mb-2'>What can I do with it?</h2>
            <p className='text-gray-700 leading-loose'>
